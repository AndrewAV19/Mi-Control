...
public class CrearTallerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        applyBackground(findViewById(R.id.crear_t), getStartColor(AppPreferences.getSelectedColor(this)), getCenterColor(AppPreferences.getSelectedColor(this)), getEndColor(AppPreferences.getSelectedColor(this)));
        ...
        bottomNavigationView.setSelectedItemId(R.id.crear_taller);
  ...
  private void chooseImage(){
    ...
    private void storeImage() {
        DbTalleres dbTalleres = new DbTalleres(CrearTallerActivity.this);
        if (!titulo.getText().toString().isEmpty() && !informacion.getText().toString().isEmpty() && !precio.getText().toString().isEmpty() && Imagentaller.getDrawable() != null) {
            ...
            dbTalleres.storeData(new Talleres(bitmapToStore, titulo.getText().toString(),informacion.getText().toString(), precioDouble));
