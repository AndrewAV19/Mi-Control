...
public class Ingreso_Ganancias_VentaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingreso_ganancias_venta);
        ...
        applyBackground(findViewById(R.id.ingreso_gan), getStartColor(AppPreferences.getSelectedColor(this)), getCenterColor(AppPreferences.getSelectedColor(this)), getEndColor(AppPreferences.getSelectedColor(this)));
        ...
        bottomNavigationView.setSelectedItemId(R.id.ingreso_ganancias_ventas);
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            switch (item.getItemId()) {
                ...
                case R.id.ingreso_general:
                    startActivity(new Intent(getApplicationContext(), Ingreso_GeneralActivity.class));
                    overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
                    finish();
                    return true;
    ...
    private double sumarPreciosPorMes(int mes, int year) {
        ...
        Cursor c = db.rawQuery(
                "SELECT SUM(" + DbHelper.TABLE_VENTAS + ".ganancias) FROM " +
