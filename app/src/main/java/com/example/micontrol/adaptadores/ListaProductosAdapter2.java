...
public class ListaProductosAdapter2 extends RecyclerView.Adapter<ListaProductosAdapter2.ProductosViewHolder> {

    ArrayList<Productos> listaProductos;
    ArrayList<Productos> listaOriginal;

    public ListaProductosAdapter2(ArrayList<Productos> listaProductos) {
    ...
    public void filtrado(String txtBuscar) {
        ...
        for (Productos producto : listaOriginal) {
            if (producto.getProducto().toLowerCase().contains(txtBuscar.toLowerCase())) {
    ...
    public void onBindViewHolder(@NonNull ProductosViewHolder holder, int position) {
        ...
        holder.ViewFolio.setText(holder.itemView.getContext().getString(R.string.CODIGO) +" "+ producto.getId());
        holder.ViewProducto.setText(holder.itemView.getContext().getString(R.string.PRODUCTO) +" "+ producto.getProducto());
        ...
        String precioCompraFormateado = format.format(producto.getPrecio_compra());
        String ganancia = format.format(producto.getGanancia());
        ...
        holder.ViewDescuento.setText(holder.itemView.getContext().getString(R.string.Desc) +" "+ producto.getDescuento()+"%");
        holder.ViewCantidad.setText(holder.itemView.getContext().getString(R.string.CANTIDADALMACEN) +" "+ producto.getCantidad());

        // Utilizar Glide para cargar la imagen y aplicar una transformación para hacerla cuadrada
        Glide.with(holder.itemView)
                .load(producto.getImagenproducto())
