...
import com.example.micontrol.adaptadores.ListaServiciosAdapter1;
...
public class EditarServicioActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {

    RecyclerView listaServicios;
    ArrayList<Servicios> listaArrayServicios;
    SearchView txtBuscar;
    ListaServiciosAdapter1 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DbServicios dbServicios = new DbServicios(EditarServicioActivity.this);

        listaArrayServicios = new ArrayList<>();

        adapter = new ListaServiciosAdapter1(dbServicios.mostrarHistorialServicios());
        ...
        applyBackground(findViewById(R.id.edit_s), getStartColor(AppPreferences.getSelectedColor(this)), getCenterColor(AppPreferences.getSelectedColor(this)), getEndColor(AppPreferences.getSelectedColor(this)));
        ...
        bottomNavigationView.setSelectedItemId(R.id.editar_servicio);
