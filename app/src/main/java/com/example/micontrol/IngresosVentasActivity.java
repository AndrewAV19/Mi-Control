...
public class IngresosVentasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingresos_ventas);
        ...
        applyBackground(findViewById(R.id.ingresos_v), getStartColor(AppPreferences.getSelectedColor(this)), getCenterColor(AppPreferences.getSelectedColor(this)), getEndColor(AppPreferences.getSelectedColor(this)));
        ...
        bottomNavigationView.setSelectedItemId(R.id.ingresos_ventas);
