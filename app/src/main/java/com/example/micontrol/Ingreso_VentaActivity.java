...
public class Ingreso_VentaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        applyBackground(findViewById(R.id.ingreso_ven), getStartColor(AppPreferences.getSelectedColor(this)), getCenterColor(AppPreferences.getSelectedColor(this)), getEndColor(AppPreferences.getSelectedColor(this)));
        ...
        bottomNavigationView.setSelectedItemId(R.id.ingreso_ventas);
